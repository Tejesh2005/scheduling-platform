...
export default function EventTypeCard({ eventType, onEdit, onDelete, onToggle }) {
  ...
  return (
    <div
      className={`group relative hover:bg-[#161616] transition-all ${
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center gap-1 text-xs text-gray-400 bg-[#1a1a1a] border border-[#282828] rounded-md px-2 py-0.5">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            {/* Hidden label when inactive */}
            {!eventType.is_active && (
              <span className="text-sm text-gray-500 mr-1 hidden sm:inline">Hidden</span>
            )}
            ...
            <div className="flex items-center gap-0.5 ml-2">
              <button
                ...
                className="p-2 rounded-md border border-[#282828] bg-[#1a1a1a] hover:bg-[#222222] text-gray-400 hover:text-white transition-colors"
                title="Preview"
              >
